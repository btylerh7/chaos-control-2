...
bass: note("<[c2@6 d2@2] [f2@3 eb2@3 d2@2]>").sound("jvbass, z_sine").struct("x(3,8)").lpf(lowpass)._scope()
arp: stack(
...
synthLead: n("<[4 2 0] [2 0 -5]>").struct("x(3,8)").sustain(1).release(1).scale("<C4:minor F4:minor C4:minor G4:major>")
  .sound("z_sawtooth").add(note("0, 0.1")).room(.5).hpf(1000).lpf(4000)
